...
const SIMPLE_API_KEY_PROVIDER_FLOWS: Partial<Record<AuthChoice, SimpleApiKeyProviderFlow>> = {
  ...
  "xiaozhiai-api-key": {
    ...
    expectedProviders: ["xiaozhiai"],
    envLabel: "XIAOZHIAI_API_KEY",
    promptMessage: "Enter 小智API key",
    setCredential: setXiaozhiaiApiKey,
    defaultModel: XIAOZHIAI_DEFAULT_MODEL_REF,
    applyDefaultConfig: applyXiaozhiaiConfig,
    applyProviderConfig: applyXiaozhiaiProviderConfig,
    noteDefault: XIAOZHIAI_DEFAULT_MODEL_REF,
    noteMessage: [
      "小智API is an OpenAI-compatible endpoint (default model: qwen3-coder-flash).",
      "Get your API key at: https://qwen.aifuture.icu",
    ].join("\n"),
    noteTitle: "小智API",
  },
  "mistral-api-key": {
